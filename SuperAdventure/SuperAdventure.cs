...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            rtbMessage.Text += newLocation.QuestAvailableHere.RewardExperiencePoints.ToString() + " experience points" + Environment.NewLine;
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
                ...
                // Display message
                rtbMessage.Text += "You hit the " + _currentMonster.Name + " for " + damageToMonster.ToString() + " points." + Environment.NewLine;
                // Check if the monster is dead
                if (_currentMonster.CurrentHitPoints <= 0)
                {
                    // Monster is dead
                    rtbMessage.Text += Environment.NewLine;
                    rtbMessage.Text += "You defeated the " + _currentMonster.Name + Environment.NewLine;
                    // Give player experience points for killing the monster
                    _player.ExperiencePoints += _currentMonster.RewardExperiencePoints;
                    rtbMessage.Text += "You receive " + _currentMonster.RewardExperiencePoints.ToString() + " experience points" + Environment.NewLine;
                    // Give player gold for killing the monster 
                    _player.Gold += _currentMonster.RewardGold;
                    rtbMessage.Text += "You receive " + _currentMonster.RewardGold.ToString() + " gold" + Environment.NewLine;
